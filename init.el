...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (tern-auto-complete tern smart-tabs-mode emmet-mode js2-mode use-package web-mode undo-tree textmate smex rainbow-delimiters paredit multiple-cursors markdown-mode magit key-chord helm expand-region doom-themes cycbuf autopair ag ace-jump-mode ace-jump-buffer ac-geiser))))
(custom-set-faces
